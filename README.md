...
The write_file("example2.txt", content_to_write) function will write;

"How brilliant that I can write to a file!" to "example2.txt".

This is because there was no existing content the example2.txt file.
